#!/usr/bin/env node
/* GENERATED in-engine verifier for odd-even-sudoku — pattern follows akari/verify_engine.js.
 ...
 * Per level: loadLevel(i); G.board = L.solution; checkWin() sets G.finished; parity markers (1=odd,2=even) must match solution parity.
 * Usage: node odd-even-sudoku/verify_engine.js   (cwd = repo root)
 */
const fs = require('fs');
const vm = require('vm');
...
console.log('odd-even-sudoku in-engine verification: ' + out.pass + '/' + out.total + ' levels, verdict=' + out.verdict);
