...
- generic [ref=e1]:
  ...
  - region "Related games" [ref=e50]:
    - generic [ref=e51]:
      - generic [ref=e52]: "Related Games:"
      - link "🦃 Catch Turkey" [ref=e53] [cursor=pointer]:
        - /url: /catch-turkey/
      - link "⚔️ Phantom Blade" [ref=e54] [cursor=pointer]:
        - /url: /phantom-blade/
      - link "🐍 Snake" [ref=e55] [cursor=pointer]:
        - /url: /snake/
      - link "🐦 Flappy Wings" [ref=e56] [cursor=pointer]:
        - /url: /flappy-wings/
      - link "🕹️ More Arcade Games" [ref=e57] [cursor=pointer]:
        - /url: /arcade-games.html
      - link "🎮 All Games" [ref=e58] [cursor=pointer]:
        - /url: /
  - button "Toggle sound" [ref=e59] [cursor=pointer]: 🔊
```