...
(function() {
  ...
  window.wx = {
    ...
    onTouchStart: function(cb) {
      ...
      document.addEventListener('touchstart', function(e) { if(e.target.tagName!=='CANVAS')return; e.preventDefault(); handle(e); }, { passive: false });
    ...
    onTouchMove: function(cb) {
      ...
      document.addEventListener('touchmove', function(e) { if(e.target.tagName!=='CANVAS')return; e.preventDefault(); handle(e); }, { passive: false });
    ...
    onTouchEnd: function(cb) {
      ...
      document.addEventListener('touchend', function(e) { if(e.target.tagName!=='CANVAS')return; e.preventDefault(); handle(e); }, { passive: false });
