...
const GAMES = [
  ...
  {name:"Word Connections",emoji:"🔗",cat:"puzzle",tags:["Puzzle","Word","Connections","Brain","Logic","Trivia","Daily","Grouping","Association","Casual"],url:"/word-connections/",desc:"Play Word Connections free online! Find groups of 4 related words in this addictive NYT Connections-style puzzle. 50 levels with color-coded categories, hints, daily challenge, share results, and stats. No download needed!",isNew:true,status:"live"},
];
