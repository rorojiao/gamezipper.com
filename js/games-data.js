...
const GAMES = [
  ...
  {name:"One Line Puzzle",emoji:"✏️",cat:"puzzle",tags:["Puzzle","Line","Dots","Connect","Brain","Logic","Path","Drawing","Casual"],url:"/one-line-puzzle/",desc:"Connect all dots with a single continuous line without crossing or retracing! 50 handcrafted levels across 5 difficulty tiers from Easy to Master. Hint system, undo, star ratings, and neon visuals. A relaxing brain teaser puzzle. No download needed!",isNew:true,status:"live"},
  {name:"One Line Connect",emoji:"🔗",cat:"puzzle",tags:["Puzzle","Line","Dots","Connect","Brain","Logic","Path","Grid","Casual"],url:"/one-line-connect/",desc:"Draw a single line to connect all dots on the grid! Visit every dot exactly once using only horizontal and vertical moves. 50 levels across 5 tiers with hint system, undo, and neon glow effects. A satisfying brain teaser puzzle!",isNew:true,status:"live"},
  {name:"Physics Draw Puzzle",emoji:"✏️",cat:"puzzle",tags:["Puzzle","Physics","Drawing","Brain","Logic","Shapes","Gravity","Creative","Casual"],url:"/physics-draw-puzzle/",desc:"Draw shapes to solve physics puzzles! Your drawings become real objects with gravity and collision. Guide balls to targets, build bridges, and push objects across 30 challenging levels. Ink limit adds strategy. No download needed!",isNew:true,status:"live"},
  {name:"Dots and Boxes",emoji:"⬜",cat:"puzzle",tags:["Puzzle","Dots","Boxes","Strategy","Board","Classic","AI","Brain","Logic","Casual"],url:"/dots-and-boxes/",desc:"Play Dots and Boxes online free! Classic strategy puzzle game vs AI. Draw lines to capture boxes and outsmart your opponent. 20 levels from 3x3 to 7x7 grids with Easy, Medium, and Hard AI. No download needed!",isNew:true,status:"live"},
  {name:"Sliding Puzzle",emoji:"🔢",cat:"puzzle",tags:["Puzzle","Sliding","15 Puzzle","Tile","Number","Brain","Logic","Classic","Casual","Grid"],url:"/sliding-puzzle/",desc:"Play Sliding Puzzle free online! Classic 15 puzzle with 3x3, 4x4, and 5x5 grids. Slide numbered tiles into order across 30 levels with star ratings, hints, undo, and timer. A timeless brain teaser. No download needed!",isNew:true,status:"live"},
...
{name:"Drive Fury",emoji:"🏎️",cat:"arcade",tags:["Arcade","Driving","Physics","Racing","Vehicle","Casual","2D","Side-Scroller"],url:"/drive-fury/",desc:"Play Drive Fury free online! Physics-based driving game with 5 vehicles and 40 levels. Tilt, flip, and race across obstacle courses in this addictive arcade game. No download needed!",isNew:true,status:"live"},
{name:"Block Blast Bingo",emoji:"🧩",cat:"puzzle",tags:["Puzzle","Block","Grid","Bingo","Drag","Drop","Casual","Combo","Arcade","Strategy"],url:"/block-blast-bingo/",desc:"Play Block Blast Bingo free online! Drag and drop colorful blocks onto an 8x8 grid. Clear rows and columns for bingo bonuses. Combo scoring, special power blocks, and endless puzzle fun. No download needed!",isNew:true,status:"live"},
  {name:"Kitchen Rush",emoji:"🍳",cat:"casual",tags:["Cooking","Time Management","Restaurant","Casual","Strategy"],url:"/kitchen-rush/",desc:"Cook delicious dishes, serve hungry customers, and manage your restaurant across 30 challenging levels in 5 unique kitchens! Upgrade stations and master burgers, pizza, sushi and more!",isNew:true,status:"live"},
{name:"Escape Manor",emoji:"🏚️",cat:"puzzle",tags:["Escape Room","Puzzle","Point and Click","Hidden Objects","Adventure","Mystery","Brain Teaser","Casual"],url:"/escape-manor/",desc:"Explore 30 mysterious rooms in a Victorian manor! Find hidden objects, solve puzzles, collect keys, and escape. 5 chapters with hint system and star ratings. No download needed!",isNew:true,status:"live"},
{name:"Jewel Coloring",emoji:"💎",cat:"puzzle",tags:["Coloring","Pixel Art","Jewel","Gem","Relaxing","Casual","Puzzle","Creative"],url:"/jewel-coloring/",desc:"Play Jewel Coloring free online! Tap numbered cells to place sparkling jewels and reveal beautiful pixel art. 30 relaxing levels across 6 categories with shimmer effects and ambient music. No download needed!",isNew:true,status:"live"},
{name:"Bridge Builder",emoji:"🌉",cat:"puzzle",tags:["Bridge","Builder","Physics","Construction","Puzzle","Engineering","Strategy","Casual"],url:"/bridge-builder/",desc:"Build bridges with wood, steel and rope to help vehicles cross gaps! 30 physics-based levels across 5 themes with budget system, 3-star ratings, undo/redo and hints. No download needed!",isNew:true,status:"live"}
];
