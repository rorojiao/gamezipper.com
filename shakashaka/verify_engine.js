#!/usr/bin/env node
/* GENERATED in-engine verifier for shakashaka — pattern follows akari/verify_engine.js.
 ...
 * Per level: initLevel(LEVELS[i], i); non-black cell.state from L.solution triples; checkCompletion() must set completionAnim=1.
 * Usage: node shakashaka/verify_engine.js   (cwd = repo root)
 */
const fs = require('fs');
const vm = require('vm');
...
console.log('shakashaka in-engine verification: ' + out.pass + '/' + out.total + ' levels, verdict=' + out.verdict);
