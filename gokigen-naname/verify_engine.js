#!/usr/bin/env node
/* GENERATED in-engine verifier for gokigen-naname — pattern follows akari/verify_engine.js.
 ...
 * Per level: initLevel(i+1) (1-based); state.grid = state.solution; checkWin() -> triggerWin sets state.won.
 * Usage: node gokigen-naname/verify_engine.js   (cwd = repo root)
 */
const fs = require('fs');
const vm = require('vm');
...
console.log('gokigen-naname in-engine verification: ' + out.pass + '/' + out.total + ' levels, verdict=' + out.verdict);
