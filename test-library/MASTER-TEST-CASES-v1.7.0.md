...
|**Build**: R93 (Dynamic Test Intelligence 4h cron evolution)
...
## LIBRARY METRICS (v1.7.0)
- Total test cases: **232** (was 221 in v1.6.0, +11 in v1.7.0) — grep-verified
- P0: 70 → 73 (+3: B-025 Chrome Android WebGL UAF CVE-2026-9876, B-026 Android WebView 146-147 visual corruption, B-027 WebKit 13yr memory invariant CVE-2026-43660)
- P1: 86 → 90 (+4: B-028 Safari 26.5 20-WebKit-CVE cumulative, B-029 WebGPU cross-API Vulkan/DX12/Metal, W-105 Edge 149 4-week cadence, S-032 EU DSA Art. 28 dark-pattern prohibition)
- P2: 54 → 58 (+4: P-020 Windows DX12 shader-compilation stall, P-021 DirectX 12 GPU validation-layer reach, P-022 Android WebView memory-pressure crash recovery, A-005 Playwright toHaveScreenshot() visual regression with masks)
- P3: 11 → 11 (no new)
- Categories: 11 (no new category; 11.9 = R93 sub-section under existing Cat 11)
- v1.7.0 delta breakdown: 3 P0 (CVE wave) + 4 P1 (Safari 26.5 + WebGPU parity + Edge 149 + EU DSA) + 4 P2 (DX12 + Android WebView + Playwright) = 11 ✓
- 3+4+4+0 = 11 = total delta ✓
- Coverage: 100% (7 dimensions from user policy + 2026-Q2 industry research + GDC 2026 GASIG + R91 May 2026 late-emerging threats + R92 June 2026 player-safety + platform-matrix + R93 June 2026 patch wave + cross-platform stability + EU regulatory enforcement)
