...
## LIBRARY METRICS (v1.2.0)
- Total test cases: **186** (was 175 in v1.0.0, +11 in v1.2.0)
- P0: 57 → 59 (+2 Chrome CVE)
- P1: 66 → 71 (+5: B-007 WebGPU, W-035 PiP, W-036 Memory Saver, A-001 dark, A-003 thumb)
- P2: 41 → 45 (+4: B-008 Safari CSS, GX-010 haptic, A-002 contrast, A-004 ARIA)
- P3: 11 → 11 (no new)
- Categories: 7 (added Category 7: Accessibility WCAG 2.2 + GDC 2026 GASIG)
- v1.2.0 delta: 4 new Industry-Specific (B-005..B-008, CVE-2026 + Safari 26.0), 2 Network (W-035 PiP, W-036 Memory Saver), 1 Multimedia (GX-010 haptic), 4 Accessibility (A-001 dark mode, A-002 WCAG contrast, A-003 Thumb Zone, A-004 ARIA)
- Coverage: 100% (all 7 dimensions from user policy + 2026-Q2 industry research + GDC 2026 GASIG accessibility)
